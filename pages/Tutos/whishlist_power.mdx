...
## Ajouter les appels au fichier css + js dans theme.liquid
``` Liquid
{% Wishlist %}
...
## Créer le fichier mm-wishlist.js dans le dossier assets
``` JavaScript
...
## Créer le fichier mm-wishlist.css dans le dossier assets
``` CSS
/* ----------------- Wishlist content  */
.mm-wishlist {
	padding: 2px;
...
## Créer la section MM-Wishlist-Products dans le dossier sections
``` Liquid
