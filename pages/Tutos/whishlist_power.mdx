...
## Setup Boutique
> Téléchargez et activez l’app (**$**15,99 / month).
>
...
```
> Si vous n'avez pas le snippet **mm-icon.liquid**, le liquid dans les fichier d'icones n'est pas utile..
...
### Ajoutez les textes de traduction dans le fichier local **en.default.json**
``` json
"wishlist": {
	"wishlist": "Wishlist",
...
### Et dans le fichier de correspondance **fr.json**
``` json
"wishlist": {
	"wishlist": "Wishlist",
