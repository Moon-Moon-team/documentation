...
function normalizePages({
  ...
  for (const currentItem of items) {
    ...
    const title = extendedMeta.title || currentItem.frontMatter?.sidebarTitle || currentItem.frontMatter?.title || // @ts-expect-error -- we use title for capitalize folders without index page
